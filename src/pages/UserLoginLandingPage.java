...
public class UserLoginLandingPage {
	...
	public UserLoginLandingPage(WebDriver driver) {
		super();
		this.driver = driver;
	...
	public static void executeLogoutViaLink(WebDriver driver) {

		driver.findElement(By.xpath(".//*[@id='login-form']/div[2]/input[1]"))
				.submit();
	}
	
	public static void logoutViaButton(WebDriver driver) {

		driver.findElement(By.xpath(".//div[@class='logout-button']/input[1]")).click();
