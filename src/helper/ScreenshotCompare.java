...
import com.sun.image.codec.jpeg.*;
 ...
 public class ScreenshotCompare {
	...
	public ScreenshotCompare() {

	}
	
	public String useExample(String imageName){
		String pathToScreenshots = "D:\\Selenium\\toolsAndStuff\\imagecompare\\";
		ScreenshotCompare ic = new ScreenshotCompare(pathToScreenshots+imageName+"_screenshot.jpg", pathToScreenshots+imageName+"_original.jpg");
		...
		String fileName = imageName+"_screenshot.jpg";
		String path = pathToScreenshots;
		FileManagement.DeleteFile(path, fileName);
		// If its not a match then write a file to show changed regions.
		if (!ic.match()) {
			//saveJPG(ic.getChangeIndicator(), "D:\\Selenium\\toolsAndStuff\\imagecompare\\difference.jpg");
			return "compare screenshot fail";
		} else {
	...
	public ScreenshotCompare(String file1, String file2) {
		this(loadJPG(file1), loadJPG(file2));
	}
 
	// constructor 2. use awt images.
	public ScreenshotCompare(Image img1, Image img2) {
	...
	public ScreenshotCompare(BufferedImage img1, BufferedImage img2) {
		this.img1 = img1;
		this.img2 = img2;
		autoSetParameters();
	}
